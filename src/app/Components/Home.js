...
function Home() {
  ...
  <div className="dropdown-menu" style={{ minWidth: '130px', width: '130px', backgroundColor:"#DCC9A3" }}>
    <Link href="/category?catcode=cat001">Grains</Link>
    <Link href="/category?catcode=cat002">Cosmetics</Link>
     </div>
</div>
          ...
          <a href="#shop" className="oh-nav__mobile-cta" onClick={() => setMenuOpen(false)}>Shop Now</a>
        </nav>

        <a href="#shop" className="oh-header__cta">Shop Now</a>
      </header>
      ...
      <section className="oh-split oh-split--grains" id="grains">
        <div className="oh-split__container">
          ...
          <div className="oh-split__content">
            ...
            <a href="#grains-collection" className="oh-btn oh-btn--solid oh-btn--wide" style={{ color: 'white' }}>
      ...
      <section className="oh-split oh-split--cosmetics" id="cosmetics">
        <div className="oh-split__container">
          <div className="oh-split__content oh-split__content--left">
            ...
            <a href="#cosmetics-collection" className="oh-btn oh-btn--solid oh-btn--wide" style={{ color: 'white' }}>
